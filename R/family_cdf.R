...
#################################################################
   txt.title <- if (missing(title))  paste("cdf from ",fname)
   else title   
...
{
  cdf11 <-  switch(nopar,
                    paste0("p",fname,"(y.var,mu.var[j], bd=bd)"),
                    paste0("p",fname,"(y.var,mu.var[j],sigma.var[j], bd=bd)"),
                    paste0("p",fname,"(y.var,mu.var[j],sigma.var[j], nu.var[j],  bd=bd)"),
                    paste0("p",fname,"(y.var,mu.var[j],sigma.var[j], nu.var[j], tau.var[j],  bd=bd)"))  
} else
{  
      cdf11 <-  switch (nopar,
                        paste0("p",fname,"(y.var,mu.var[j])"),
                        paste0("p",fname,"(y.var,mu.var[j],sigma.var[j])"),
                        paste0("p",fname,"(y.var,mu.var[j],sigma.var[j], nu.var[j])"),
