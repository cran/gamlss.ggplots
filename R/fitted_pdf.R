...
switch(nopar,
            {
            pdfArr[[i]] <- pdf(y.var[[i]],  mu=MM[i,2],  bd=MM[i,lastcolMM])
            },  
            {
            pdfArr[[i]] <- pdf(y.var[[i]], mu=MM[i,2],  sigma=MM[i,3], bd=MM[i,lastcolMM])
            },
            {
            pdfArr[[i]] <- pdf(y.var[[i]],  mu=MM[i,2], sigma=MM[i,3], nu=MM[i,4], bd=MM[i,lastcolMM])
            },
            {
            pdfArr[[i]] <- pdf(y.var[[i]],  mu=MM[j,2], sigma=MM[i,3], nu=MM[i,4], tau=MM[i,5],  bd=MM[i,lastcolMM])  
            })  
